...
namespace PowerPointLabs.Converters.ColorPane
{
    ...
    {
        public static SelectedColorToSplitComplementaryHigher Instance = new SelectedColorToSplitComplementaryHigher();
        ...
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            Color convertedColor = ColorHelper.GetColorShiftedByAngle(selectedColor, 210.0f);
