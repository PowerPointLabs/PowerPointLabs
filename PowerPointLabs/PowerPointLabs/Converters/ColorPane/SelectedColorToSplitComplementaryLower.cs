...
namespace PowerPointLabs.Converters.ColorPane
{
    ...
    {
        public static SelectedColorToSplitComplementaryLower Instance = new SelectedColorToSplitComplementaryLower();
        ...
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            Color convertedColor = ColorHelper.GetColorShiftedByAngle(selectedColor, 150.0f);
