...
namespace PowerPointLabs.Converters.ColorPane
{
    ...
    {
        public static SelectedColorToTetradicThree Instance = new SelectedColorToTetradicThree();
        ...
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            Color convertedColor = ColorHelper.GetColorShiftedByAngle(selectedColor, 270.0f);
