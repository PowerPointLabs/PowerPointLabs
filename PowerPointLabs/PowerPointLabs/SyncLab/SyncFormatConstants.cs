            ...
            FormatTreeNode[] formats =
                {
                    ...
                    new FormatTreeNode(
                            ...
                            new FormatTreeNode("3D Rotation",
                                new FormatTreeNode("X", new ThreeDRotationEffectRotationXFormat()),
                                new FormatTreeNode("Y", new ThreeDRotationEffectRotationYFormat()),
                                new FormatTreeNode("Z", new ThreeDRotationEffectRotationZFormat()),
                                new FormatTreeNode("Perspective", new ThreeDRotationEffectPerspectiveFormat()),
                                new FormatTreeNode("Keep Text Flat", new ThreeDRotationEffectProjectTextFormat()),
                                new FormatTreeNode("Distance To Ground", new ThreeDRotationEffectZFormat()))),
                    new FormatTreeNode(
                            "Size/Position",
