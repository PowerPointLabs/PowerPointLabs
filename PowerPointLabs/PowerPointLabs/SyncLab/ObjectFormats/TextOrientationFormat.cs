...
{
    class TextOrientationFormat : Format
    {
        ...
        public override void SyncFormat(Shape formatShape, Shape newShape)
        {
            ...
            {
                Logger.Log(newShape.Type + " unable to sync Text Orientation");
            }
        }
        ...
        private static bool Sync(Shape formatShape, Shape newShape)
        {
            try
            {
                newShape.TextFrame.Orientation = formatShape.TextFrame2.Orientation;
            }
            catch (Exception e)
            {
                Logger.LogException(e, "Sync TextOrientationFormat");
                return false;
            }
            return true;
        }
