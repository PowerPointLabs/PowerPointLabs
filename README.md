...
4. If failed to build PowerPointLabs solution, try to install `VSTO for PowerPoint` from the link inside [this file](http://powerpointlabs.info/vsto-redirect.html).
